...
<p align="center"><img src="https://github.com/hackathonismb/ImmunoZoo/blob/main/images/immunozoo.png" width="400" height="auto"></p>
...
* python: 
```
python -m http.server | python -m webbrowser 'http://localhost:8000/icn3d/?menuconfig=menu.json&type=pdb&url=/structures/3WD5_icn3d.pdb'
```
...
#### Improving Usabilty is Big, How Should we Approach This?
Can we survey users for their 10 essentials? <br>
* side by site is cool - another journey :)

Separate hard core structural biology from general use? Molecule World provides insights. <br>
